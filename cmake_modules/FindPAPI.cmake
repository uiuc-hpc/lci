# Copyright (c)      2014 Thomas Heller Copyright (c) 2007-2011 Hartmut Kaiser
# Copyright (c) 2011      Bryce Lelbach Copyright (c) 2011      Maciej Brodowicz
#
...
if(NOT TARGET Papi::papi)
  ...
  find_path(
    ...
    HINTS ${PAPI_ROOT} $ENV{PAPI_ROOT} ${PC_PAPI_INCLUDEDIR}
          ${PC_PAPI_INCLUDE_DIRS} $ENV{PAPIHOME}
    PATH_SUFFIXES include)

  find_library(
    PAPI_LIBRARY
    NAMES papi libpapi
    HINTS ${PAPI_ROOT} $ENV{PAPI_ROOT} ${PC_PAPI_LIBDIR} ${PC_PAPI_LIBRARY_DIRS}
          $ENV{PAPIHOME}
  ...
  find_package_handle_standard_args(PAPI DEFAULT_MSG PAPI_LIBRARY
                                    PAPI_INCLUDE_DIR)
