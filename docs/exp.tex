    ...
    \subfigure[Latency per message transfer for $14$ threads, one per worker/socket.] {
      ...
      \begin{tikzpicture}[scale=.9]
        \begin{axis}[xlabel=Message Size (byte), ylabel=Latency (usec),
          ...
          \addplot table [x=threads, y=mvapich2+mt] {data/pingpong2.dat} node[pos=0.27, pin=below:95.2]{};
          \addlegendentry{mvapich2+mt}
          \addplot table [x=threads, y=pthread+hash] {data/pingpong2.dat} node [pos=0.25, pin=above:5.6]{};
...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=0.9]
    \begin{axis}[xlabel=Message Size (byte), ylabel=Latency (usec),
      ...
      \addplot table [x=threads, y=mvapich2+mt] {data/pingpong1.dat} node[pos=0.24, pin=above:1.52]{};
      \addlegendentry{mvapich2+mt}
      \addplot table [x=threads, y=pthread+hash] {data/pingpong1.dat} node[pos=0.24, pin=right:3.6]{};
      \addlegendentry{pthread+hash}
      \addplot table [x=threads, y=abt+hash] {data/pingpong1.dat} node[pos=0.24, pin=above:1.8]{};
      \addlegendentry{abt+hash}
      \addplot table [x=threads, y=fult+hash] {data/pingpong1.dat} node[pos=0.24, pin=right:1.43]{};
      \addlegendentry{fult+hash}
      \pgfplotsset{cycle list shift=1}
      \addplot table [x=threads, y=mvapich2] {data/pingpong1.dat}; % node[pos=0.24, pin=right:1.42]{};
