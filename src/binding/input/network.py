...
operation(
    ...
    [
        ...
        positional_arg("uint64_t", "offset", comment="The offset of the remote uint64 from the remote region base. The resulting remote address must be 8-byte aligned."),
        positional_arg("rmr_t", "rmr", comment="The remote memory region handle."),
