...
{
  LCI_IMMEDIATE_SIZE = LC_MAX_INLINE;
  LCI_BUFFERED_SIZE = LC_PACKET_SIZE;
  LCI_DEFAULT_MT_LENGTH = 1 << TBL_BIT_SIZE;
  LCI_MAX_MT_LENGTH = 1 << TBL_BIT_SIZE;
  LCI_DEFAULT_CQ_LENGTH = CQ_MAX_SIZE;
  LCI_MAX_CQ_LENGTH = CQ_MAX_SIZE;
