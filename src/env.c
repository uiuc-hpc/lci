...
void lc_env_init(int num_proc, int rank)
{
  ...
  LCI_SERVER_NUM_PKTS = getenv_or("LCI_SERVER_NUM_PKTS", LCI_SERVER_NUM_PKTS_DEFAULT);
  LCI_DEFAULT_QUEUE_LENGTH = getenv_or("LCI_MAX_QUEUE_LENGTH", LCI_SERVER_NUM_PKTS * 2);
  LCI_MAX_QUEUE_LENGTH = getenv_or("LCI_MAX_QUEUE_LENGTH", LCI_SERVER_NUM_PKTS * 2);
  LCI_SERVER_MAX_SENDS = getenv_or("LCI_SERVER_MAX_SENDS", LCI_SERVER_MAX_SENDS_DEFAULT);
  LCI_SERVER_MAX_RECVS = getenv_or("LCI_SERVER_MAX_RECVS", LCI_SERVER_MAX_RECVS_DEFAULT);
  LCI_SERVER_MAX_CQES = getenv_or("LCI_SERVER_MAX_CQES", LCI_SERVER_MAX_CQES_DEFAULT);
  LCI_IBV_ENABLE_EVENT_POLLING_THREAD = getenv_or("LCI_IBV_ENABLE_EVENT_POLLING_THREAD", false);
}