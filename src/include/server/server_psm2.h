...
static inline void lc_server_post_recv_rma(LCIS_server_t s, void* addr,
...
static inline struct psm_mr* lc_server_get_free_mr(LCIS_server_t s)
{
...
static inline uintptr_t _real_psm_reg(LCIS_server_t s, void* buf, size_t size)
{
...
static inline int lc_server_progress(LCIS_server_t s)
{
  psm2_mq_req_t req;
...
static inline void lc_server_sends(LCIS_server_t s, void* rep, void* ubuf,
...
#if 0
static inline void lc_server_get(LCIS_server_t s, int rank, void* buf,
...
static inline void lc_server_rma_rtr(LCIS_server_t s, void* rep, void* buf,
...
static inline void lc_server_finalize(LCIS_server_t s) { free(s); }
