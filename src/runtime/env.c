...
LCI_API int LCI_SINGLE_THREAD_PROGRESS;
...
void LCII_env_init(int num_proc, int rank)
{
  ...
  LCI_SINGLE_THREAD_PROGRESS = LCIU_getenv_or(
      "LCI_SINGLE_THREAD_PROGRESS", LCI_SINGLE_THREAD_PROGRESS_DEFAULT);
#ifdef LCI_ENABLE_SLOWDOWN
  LCI_SEND_SLOW_DOWN_USEC = LCIU_getenv_or(
      "LCI_SEND_SLOW_DOWN_USEC", 0);
  LCI_RECV_SLOW_DOWN_USEC = LCIU_getenv_or(
