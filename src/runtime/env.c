...
LCI_API int LCI_DEFAULT_TABLE_LENGTH = 1u << LCM_HASHTABLE_BIT_SIZE;
...
void LCII_env_init(int num_proc, int rank)
{
  ...
  LCI_REGISTERED_SEGMENT_SIZE =
      LCIU_getenv_or("LCI_REGISTERED_SEGMENT_SIZE", LCI_DEV_MEM_SIZE);
  ...
  LCI_DEFAULT_QUEUE_LENGTH =
      LCIU_getenv_or("LCI_MAX_QUEUE_LENGTH", LCI_SERVER_NUM_PKTS * 2);
